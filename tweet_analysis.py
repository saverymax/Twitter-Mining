...
def read_tweets(user): # add senators filer here and open it in next line
  
    path = '/home/timor/Documents/Git/Twitter-Mining/twitter_data'
    os.chdir(path)

    with open(user + '_twitter_data.json', 'r') as infile:
...
if __name__ == '__main__':
    try:
        tweets = read_tweets(sys.argv[1])# Lookup file
        ...
        print("Senator twitter data was not found")
